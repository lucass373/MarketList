...
export default function GastoScreen(/*{ colorScheme } : {colorScheme : ColorSchemeName}*/) {
  return (
    <NavigationContainer
      independent={true}
...
function RootNavigator() {
  return (
    <Stack.Navigator>
      <Stack.Screen
        name="GastoScreen"
        component={GastoScreen1}
        options={{ headerShown: false, animation: 'none' }}
        initialParams={{ index: new Date().getMonth() }}
      />
      <Stack.Screen
        name="GastoScreen2"
        component={GastoScreen2}
        options={{ headerShown: false, animation: 'none' }}
      />
    </Stack.Navigator>
  )
...
function GastoScreen1({ navigation, route }) {
  const meses = [
    'Janeiro',
    'Fevereiro',
    'Março',
        ...
        <View style={styles.container2}>
          <Swiper
            onIndexChanged={index =>
              navigation.navigate('GastoScreen2', { index: index })
            }
            index={index}
            dot={<></>}
            activeDot={<></>}
